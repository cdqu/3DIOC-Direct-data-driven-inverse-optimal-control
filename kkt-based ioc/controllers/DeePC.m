classdef DeePC < handle
    ...
    methods
        function obj = DeePC(constraints, yf, uf, params, data)
            obj.yf = yf;
            obj.uf = uf;
        ...
        function init_optimizer(obj)
            ...
            % cons_no_red = [u_var' == obj.Uf*pinv([obj.Up; obj.Yp; obj.Yf])...
            %     *[u_ini'; reshape(y_ini,[],1); reshape(y_var,[],1)]];
            cons_no_red = [reshape(y_var,[],1) == obj.Yf*pinv([obj.Up; obj.Yp; obj.Uf])...
                *[reshape(u_ini, [], 1); reshape(y_ini,[],1); reshape(u_var,[],1)]];
            for i = 1:N
                objective = objective ...
            ...
            obj.yalmip_optimizer = optimizer( ...
                ...
                {u_var, y_var,g, objective} ...  % outputs
            );
        end

        function [u, U, Y, info] = solve(obj, u_ini, y_ini)
